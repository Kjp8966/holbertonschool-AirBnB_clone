...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, arg):
        """Creates a new instance, sets its name, saves it, and prints its ID                         Usage: $ create <class name> [<instance name>]"""
        args = arg.split()
    ...
    def do_destroy(self, arg):
        """Deletes an instance based on class name and ID                                             Usage: $ destroy <class name> <id>"""
    args = arg.split()
    if not self._validate_class_and_id(args):
        return
    object_instances = storage.all()
    ...
    print(instance)
elif len(args) == 1:                                                                            if args[0] in self.class_dict:
